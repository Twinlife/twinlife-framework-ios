...
//
// Interface: TLAuthChallengeIQSerializer
//

@interface TLAuthChallengeIQSerializer : TLBinaryPacketIQSerializer
...
//
// Interface: TLAuthChallengeIQ
//

@interface TLAuthChallengeIQ : TLBinaryPacketIQ
