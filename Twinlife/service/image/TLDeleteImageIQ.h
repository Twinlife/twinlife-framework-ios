...
//
// Interface: TLDeleteImageIQSerializer
//

@interface TLDeleteImageIQSerializer : TLBinaryPacketIQSerializer
...
//
// Interface: TLDeleteImageIQ
//

@interface TLDeleteImageIQ : TLBinaryPacketIQ
